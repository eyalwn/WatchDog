...
*	Description:	pqueue header file
*******************************************************************************/
#ifndef _PQUEUE_H_
#define _PQUEUE_H_
 ...
 *	current_data.
 */ 
typedef int(*has_higher_priority_t)(void *current_data, const void *new_data,
														void *param);
...
/***************************** PQErase *****************************************
 *	Description: Erases from the queue the 1st matching element using 
 *               pq_is_match function provided by client.
