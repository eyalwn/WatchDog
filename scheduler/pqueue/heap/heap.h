...
*									 then the new_data.
*/
typedef int (*heap_is_before_t)(void *heap_data,
									 const void *new_data,
							   		 void *param);
...
*/
typedef int(*heap_is_match_t)(void *new_data, void *heap_data);
...
/***************************** HeapPush ****************************************
 *	Description: Stores the data pointer in the heap according to heap policy.
 *  		     In some cases the memory storage might increase dynamically.
 ...
 * 				 In some cases the memory storage might decrease dynamically.
 *
 ...
 *               is_match_func - user defined function to detemine if two
 *               elements are match.
...
/***************************** HeapSetParam ************************************
 *	Description: allows to re-set param with the new received param.
 *
 *	Input:		 param
 *
 *	Output:		 none.
